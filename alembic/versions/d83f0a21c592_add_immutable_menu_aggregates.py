"""Add the bounded nine-table immutable Menu aggregate and lifecycle writer.

Downgrade destroys Menu history only; re-upgrade cannot recover it. Provider
objects and rows are untouched. Execute against disposable data for review.

Revision ID: d83f0a21c592
Revises: b72e6a90c431
...
revision: str = "d83f0a21c592"
down_revision: str | Sequence[str] | None = "b72e6a90c431"
...
def downgrade() -> None:
    op.execute("DROP TRIGGER trg_menu_currency_insert ON menu.currency")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.currency")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.currency")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.menu_page")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.menu_page")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.menu_page")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.menu_page")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.menu_applicability")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.menu_applicability")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.menu_applicability")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.menu_applicability")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.menu_section")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.menu_section")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.menu_section")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.menu_section")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.menu_item")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.menu_item")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.menu_item")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.menu_item")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.menu_variant")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.menu_variant")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.menu_variant")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.menu_variant")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.menu_modifier")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.menu_modifier")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.menu_modifier")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.menu_modifier")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.price_observation")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.price_observation")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.price_observation")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.price_observation")
    op.execute("DROP TRIGGER trg_menu_immutable ON menu.evidence_link")
    op.execute("DROP TRIGGER trg_menu_no_truncate ON menu.evidence_link")
    op.execute("DROP TRIGGER trg_menu_admit ON menu.evidence_link")
    op.execute("DROP TRIGGER ct_menu_integrity ON menu.evidence_link")
    op.execute("DROP FUNCTION menu.check_integrity()")
    op.execute("DROP FUNCTION menu.check_aggregate(bigint)")
    op.execute("DROP FUNCTION menu.check_context(bigint[])")
    op.execute("DROP FUNCTION menu.node_path(text, bigint)")
    op.execute("DROP FUNCTION menu.nodes(bigint)")
    op.execute("DROP FUNCTION menu.admit_member()")
    op.execute("DROP FUNCTION menu.admit_page()")
    op.execute("DROP FUNCTION menu.admit_scope(menu.menu_page)")
    op.execute("DROP FUNCTION menu.lock_admission()")
    op.execute("DROP FUNCTION menu.reject_mutation()")
    op.execute("DROP FUNCTION menu.input_committed(xid)")
    op.execute("DROP TABLE menu.evidence_link")
    op.execute("DROP TABLE menu.price_observation")
    op.execute("DROP TABLE menu.menu_modifier")
    op.execute("DROP TABLE menu.menu_variant")
    op.execute("DROP TABLE menu.menu_item")
    op.execute("DROP TABLE menu.menu_section")
    op.execute("DROP TABLE menu.menu_applicability")
    op.execute("DROP TABLE menu.menu_page")
    op.execute("DROP TABLE menu.currency")
    op.execute("DROP SEQUENCE menu.admission_fence")
    op.execute("DROP FUNCTION menu.valid_tags(text[])")
    op.execute("DROP FUNCTION menu.whitespace()")
    op.execute("DROP SCHEMA menu")
