...
def upgrade() -> None:
    if not _table_exists("deal_observations"):
        op.create_table(
            "deal_observations",
    ...
    if not _index_exists("deal_applicability", "ix_deal_applicability_observation_id"):
        op.create_index("ix_deal_applicability_observation_id", "deal_applicability", ["observation_id"])
    if not _index_exists("deal_applicability", "ix_deal_applicability_scope"):
        op.create_index("ix_deal_applicability_scope", "deal_applicability", ["applicability_scope"])
    if not _index_exists("deal_applicability", "ix_deal_applicability_canonical_venue_id"):
        op.create_index("ix_deal_applicability_canonical_venue_id", "deal_applicability", ["canonical_venue_id"])
    if not _index_exists("deal_applicability", "ix_deal_applicability_brand_group_id"):
        op.create_index("ix_deal_applicability_brand_group_id", "deal_applicability", ["brand_group_id"])
    if not _index_exists("deal_applicability", "ix_deal_applicability_is_active"):
        op.create_index("ix_deal_applicability_is_active", "deal_applicability", ["is_active"])
    if not _index_exists("deal_applicability", "ix_deal_applicability_observation_active"):
