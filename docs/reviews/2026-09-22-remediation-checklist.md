...
| 6b | S6b Platform menu URLs alongside site menus (only if D4.6 = S6b) | D4.6 + S6 merged | S | [ ] |
...
- **4.6 Platform menu URLs alongside the site's own menu** (D3.5 carry-over; asked in
  ...
  - [ ] ⭐ S6 adopts only the key rule; collecting platform links even when a site
...
### S6b — Platform menu URLs alongside site menus · size S · needs D4.6 = S6b + S6 merged
...
| 2026-09-23 | S5 | docs/adr-0011-evidence-endpoints | #27 | Draft, awaiting owner acceptance of ADR-0011 | — (D4 answered; new D4.6/D4.7 to tick when accepting; S6 waits on acceptance) |
