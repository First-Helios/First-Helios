...
Can be exercised independently before wiring into the main server:
    ...
    python -c "from listings.ingest import ingest_job_posting; print('OK')"
    python -c "from backend.database import init_db; init_db()"  # creates job_postings table
...
from listings.ingest import expire_stale_postings, ingest_job_posting
